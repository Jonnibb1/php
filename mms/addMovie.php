...
if(isset($_POST['submit'])){
    ...
    $insertMovie->bindParam(':movie_name', $movie_desc);
    
    $insertMovie->bindParam(':movie_name', $movie_quality);
    
    $insertMovie->bindParam(':movie_name', $movie_rating);
    
    $insertMovie->bindParam(':movie_name', $movie_image);
